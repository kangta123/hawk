...
helm install --set global.jwtPolicy=first-party-jwt istiod ./istio/istio-control/istio-discovery -n ${istions}
helm install --set global.jwtPolicy=first-party-jwt istio-ingress ./istio/gateways/istio-ingress -n ${istions}
helm install --set global.jwtPolicy=first-party-jwt istio-egress ./istio/gateways/istio-egress -n ${istions}
