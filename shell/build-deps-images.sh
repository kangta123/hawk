...
# cd run && docker build -t ${imageReg}/hawk_tomcat8:v4.0 -f tomcat/Dockerfile_JDK8 .
# docker push ${imageReg}/hawk_tomcat8:v4.0
# cd ${root}
# cd run && docker build -t ${imageReg}/hawk_tomcat11:v4.0 -f tomcat/Dockerfile_JDK11 .
# docker push ${imageReg}/hawk_tomcat11:v4.0
# cd ${root}
#
# echo "build springboot runtime image"
# cd run && docker build -t ${imageReg}/hawk_springboot8:v4.0 -f springboot/Dockerfile_JDK8 .
# docker push ${imageReg}/hawk_springboot8:v4.0
# cd ${root}
cd run && docker build -t ${imageReg}/hawk_springboot11:v4.0 -f springboot/Dockerfile_JDK11 .
docker push ${imageReg}/hawk_springboot11:v4.0
cd ${root}
